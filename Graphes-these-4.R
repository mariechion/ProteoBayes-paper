...
# )
# 
# gg4_1 = plot_dif(res_graph3_ups_uni, c('Point1', 'Point7'), peptide = pept_ups) +
#   xlim(c(-1,10)) + ylim(c(0,0.4))
# xlab(TeX('$\\mu_1 - \\mu_7$ - ups'))
# gg4_2 = plot_dif(res_graph3_ups_uni_imp, c('Point1', 'Point7'), peptide = pept_ups) +
#   xlim(c(-1,10)) + ylim(c(0,0.4)) 
# xlab(TeX('$\\mu_1 - \\mu_7$- ups - imp'))
# gg4_3 = plot_dif(res_graph3_arath_uni, c('Point1', 'Point7'), peptide = pept_arath) +
#   xlim(c(-2,3)) + ylim(c(0,0.9))
# xlab(TeX('$\\mu_1 - \\mu_7$- arath'))
# gg4_4 = plot_dif(res_graph3_arath_uni_imp, c('Point1', 'Point7'), peptide = pept_arath) +
#   xlim(c(-2,3)) + ylim(c(0,0.9)) 
# xlab(TeX('$\\mu_1 - \\mu_7$'))
# 
